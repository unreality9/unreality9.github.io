...
const CACHE_NAME = "zneo-cache";
const OFFLINE_URL = "zneo.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["zneo.html","zneo.js","zneo.wasm","zneo.pck","zneo.offline.html","zneo.icon.png","zneo.apple-touch-icon.png"];
